...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.create = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var salt, hash, hashPassword, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        hash = (_a.sent());
                        hashPassword = salt + '.' + hash.toString('hex');
                        user = this.repo.create({ email: email, password: password, status: true });
                        return [2 /*return*/, this.repo.save(user)];
                }
            });
        });
    };
    UsersService.prototype.signin = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var user, _a, salt, storeHash, hash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.repo.find({ email: email })];
                    case 1:
                        user = (_b.sent())[0];
                        if (!user) {
                            throw new common_1.NotFoundException('user not found');
                        }
                        _a = user.password.split('.'), salt = _a[0], storeHash = _a[1];
                        return [4 /*yield*/, scrypt(password, salt, 32)];
                    case 2:
                        hash = (_b.sent());
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.repo["delete"](user)];
                }
            });
        });
    };
