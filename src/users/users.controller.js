...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.createUser = function (body, session) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.UserService.create(body.email, body.password)];
                    case 1:
                        user = _a.sent();
    ...
    UsersController.prototype.signin = function (body, session) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.UserService.signin(body.email, body.password)];
                    case 1:
                        user = _a.sent();
                        session.userId = user.id;
                        return [2 /*return*/, user];
    ...
    __decorate([
        ...
        __param(0, (0, common_1.Body)()),
        __param(1, (0, common_1.Session)())
    ], UsersController.prototype, "signin");
    __decorate([
        (0, common_1.Get)('/:id'),
